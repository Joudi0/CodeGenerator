...
{
    public class clsMysqlDAL
    {
        static string tabs = "        ";
        private static string GetMySqlDbType(string csharpType)
        {
            switch (csharpType.Replace("?", "").Trim())
            {
                case "string": return "MySqlDbType.VarChar";
                case "int": return "MySqlDbType.Int32";
                case "long": return "MySqlDbType.Int64";
                case "short": return "MySqlDbType.Int16";
                ...
                case "TimeSpan": return "MySqlDbType.Time";
        ...
        public static string addParametersAllScript(bool withoutFirst = true, string dtoParamName = "dto")
        {
            ...
            foreach (Column col in newColumns)
            {
                ...
                string dbType = GetMySqlDbType(col.type);
        ...
        {{
            using MySqlConnection connection = new MySqlConnection(clsDataSettings.connectionString);
            using MySqlCommand command = new MySqlCommand(""SP_{tableName}_GetSecurityDataByUsername"", connection);
        ...
        {{
            using MySqlConnection connection = new MySqlConnection(clsDataSettings.connectionString);
            using MySqlCommand command = new MySqlCommand(""SP_{tableName}_SelectBy{C.name}"", connection);
            command.CommandType = CommandType.StoredProcedure;
...
{generateFullDTOMapping()}
        ...
        {{
            int rowsAffected = 0;
            using MySqlConnection connection = new MySqlConnection(clsDataSettings.connectionString);
            using MySqlCommand command = new MySqlCommand(""SP_{tableName}_Update"", connection);
            command.CommandType = CommandType.StoredProcedure;
        ...
        {{
            int {objectName}ID = -1;
            using MySqlConnection connection = new MySqlConnection(clsDataSettings.connectionString);
            using MySqlCommand command = new MySqlCommand(""SP_{tableName}_Insert"", connection);
            command.CommandType = CommandType.StoredProcedure;
        ...
        {{
            int rowsAffected = 0;
            using MySqlConnection connection = new MySqlConnection(clsDataSettings.connectionString);
            using MySqlCommand command = new MySqlCommand(""SP_{tableName}_Delete"", connection);
            command.CommandType = CommandType.StoredProcedure;
            command.Parameters.AddWithValue(""@{C.name}"", {C.name});
            try
            {{
        ...
        {{
            ...
            using MySqlConnection connection = new MySqlConnection(clsDataSettings.connectionString);
            using MySqlCommand command = new MySqlCommand(""SP_{tableName}_SelectAll"", connection);
            command.CommandType = CommandType.StoredProcedure;
...
{generateFullDTOMapping()}
        ...
        {{
            List<{clsHelper.className}FullOutputDTO> list = new List<{clsHelper.className}FullOutputDTO>();
            using MySqlConnection connection = new MySqlConnection(clsDataSettings.connectionString);
            using MySqlCommand command = new MySqlCommand(""SP_{tableName}_SelectAllBy{C.name}"", connection);
            command.CommandType = CommandType.StoredProcedure;
            command.Parameters.AddWithValue(""@{C.name}"", {C.name});
...
{generateFullDTOMapping()}
        ...
        {{
            bool isFound = false;
            using MySqlConnection connection = new MySqlConnection(clsDataSettings.connectionString);
            using MySqlCommand command = new MySqlCommand(""SP_{tableName}_IsExistBy{C.name}"", connection);
            command.CommandType = CommandType.StoredProcedure;
            command.Parameters.AddWithValue(""@{C.name}"", {C.name});
        ...
        {{
            List<{clsHelper.className}FullOutputDTO> list = new List<{clsHelper.className}FullOutputDTO>();
            using MySqlConnection connection = new MySqlConnection(clsDataSettings.connectionString);
            using MySqlCommand command = new MySqlCommand(""SP_{tableName}_Paging"", connection);
            command.CommandType = CommandType.StoredProcedure;
...
{generateFullDTOMapping()}
        ...
        {
            string structure = $@"using MySql.Data.MySqlClient;
using System;
using System.Collections.Generic;
using System.Data;
using System.Threading.Tasks;
